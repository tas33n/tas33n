...
async function updateReadme() {
  ...
  const mostActiveRepoRegex = /<a href="https:\/\/github\.com\/tas33n\/.*">\s*<img src="https:\/\/github-readme-stats\.vercel\.app\/api\/pin\/\?username=tas33n&repo=.*&theme=radical" alt="Most Active Repository" \/>\s*<\/a>/;
  const newMostActiveRepoContent = `<a href="${mostActiveRepo.html_url}">\n    <img src="https://github-readme-stats.vercel.app/api/pin/?username=tas33n&repo=${mostActiveRepo.name}&theme=radical" alt="Most Active Repository" />\n  </a>`;
